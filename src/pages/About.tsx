        ...
        <>
            <div className="about-container">
                ...
                <p>
                    ...
                    park! Simply , where you can easily create new translations by
                    entering your text and selecting the target language. Once you've
                    added your translations, viewing them is just as straightforward.
                    Everything is neatly organized, so you can quickly access and
                    manage your entries. Whether you're updating existing
                    translations or browsing through your collection.
                </p>
                <p>
                ...
                <p>
                    <div className="list-wrapper">
                        ...
                        <ul>
                            ...
                            <li>Refine translations existing lyrics.</li>
